"""
Django settings for round_feather_40076 project.
...
ROOT_URLCONF = 'round_feather_40076.urls'
...
WSGI_APPLICATION = 'round_feather_40076.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_feather_40076 API",
    "DESCRIPTION": "API documentation for round_feather_40076 App",
    "VERSION": "v1",
}
